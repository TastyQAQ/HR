        ...
        <el-row type="flex" justify="space-between" align="middle">
          ...
          <el-col :span="24">
            <el-row type="flex" justify="end">
              ...
              <el-button size="mini" type="primary">設置</el-button>
            </el-row>
          </el-col>
        </el-row>
      </el-card>
      <el-card class="page-tools">
        <el-form label-width="120px">
          <el-form-item label="部門:">
            <el-checkbox-group v-model="departmentIds">
          ...
          <div style="width: 3000px">
            <table data-v-807157d0="" border="0" align="center" cellpadding="0" cellspacing="0" class="tableInfo">
              ...
              <tr v-for="(item, index) in attendanceList" :key="item.mobile">
                ...
                <td>{{ item.mobile }} </td>
                <td v-for="items in item.attendanceRecord" :key="items.day">{{ items.adtStatu }}</td>
              </tr>
            </table>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async getAttendanceList() {
      ...
      // console.log(result.data.rows[0].attendanceRecord)
    }
  }
}
</script>
