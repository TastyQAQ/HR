    ...
    <div class="container">
      ...
      <div class="left">
        <div class="panel">
          ...
          <div class="user-info">
            ...
            <span v-else class="username">{{ name[0] }}</span>
        ...
        <!-- 圖表數據 -->
        <div class="panel">
          <div class="panel-title">社保申報數據</div>
        ...
        <!-- 圖表數據 -->
        <div class="panel">
          <div class="panel-title">公積金申報數據</div>
          <div class="chart-container">
            <div class="chart-info">
              <div class="info-main">
                <span>申報人數</span>
      ...
      <div class="right">
        ...
        <div class="panel">
          <div class="help">
            <div class="help-left">
              <div class="panel-title">幫助鏈接</div>
              <div class="help-list">
...
import { LineChart } from 'echarts/charts' // 引入折線圖
...
export default {
  ...
  methods: {
    ...
    async getHomeData() {
      ...
      this.homeNotice = await getHomeNotice()
    }
  }
}
</script>
